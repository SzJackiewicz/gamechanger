                    ...
                    <div className='col-lg-8 m-auto'>
                      <div className='box-list-posts mt-30'>
                        <div className='card-list-posts card-list-posts-small border-bottom border-gray-800 pb-30 mb-30 wow animate__animated animate__fadeIn'>
                          ...
                          <div className='card-info'>
                            <Link href='/single-sidebar'>
                              <h3 className='mb-20 color-white'>What Are NFTs? Non-Fungible Tokens &amp; Crypto Art Explained</h3>
                            </Link>
                            <p className='color-gray-500'>
                              Gosh jaguar ostrich quail one excited dear hello and bound and the and bland moral misheard roadrunner flapped
                        ...
                        <div className='card-list-posts card-list-posts-small border-bottom border-gray-800 pb-30 mb-30 wow animate__animated animate__fadeIn'>
                          ...
                          <div className='card-info'>
                            <Link href='/single-sidebar'>
                              <h3 className='mb-20 color-white'>5 Resources To Find Diverse Stock Images For Your Website</h3>
                            </Link>
                            <p className='color-gray-500'>
                              Gosh jaguar ostrich quail one excited dear hello and bound and the and bland moral misheard roadrunner flapped
                              lynx far that and jeepers giggled far and far
                        ...
                        <div className='card-list-posts card-list-posts-small border-bottom border-gray-800 pb-30 mb-30 wow animate__animated animate__fadeIn'>
                          ...
                          <div className='card-info'>
                            <Link href='/single-sidebar'>
                              <h3 className='mb-20 color-white'>What if you could spend the lockdown at Hogwarts</h3>
                            </Link>
                            <p className='color-gray-500'>
                              Gosh jaguar ostrich quail one excited dear hello and bound and the and bland moral misheard roadrunner flapped
                              lynx far that and jeepers giggled far and far
                        ...
                        <div className='card-list-posts card-list-posts-small border-bottom border-gray-800 pb-30 mb-30 wow animate__animated animate__fadeIn'>
                          ...
                          <div className='card-info'>
                            <Link href='/single-sidebar'>
                              <h3 className='mb-20 color-white'>Inside 3D Illustration with Elements Author Amrit Pal Singh</h3>
                            </Link>
                            <p className='color-gray-500'>
                              Gosh jaguar ostrich quail one excited dear hello and bound and the and bland moral misheard roadrunner flapped
                              lynx far that and jeepers giggled far and far
                        ...
                        <div className='card-list-posts card-list-posts-small border-bottom border-gray-800 pb-30 mb-30 wow animate__animated animate__fadeIn'>
                          ...
                          <div className='card-info'>
                            <Link href='/single-sidebar'>
                              <h3 className='mb-20 color-white'>Indian digital artists are exploring the latest craze: Cryptoart</h3>
                            </Link>
                            <p className='color-gray-500'>
                              Gosh jaguar ostrich quail one excited dear hello and bound and the and bland moral misheard roadrunner flapped
                              lynx far that and jeepers giggled far and far
                        ...
                        <div className='card-list-posts card-list-posts-small border-bottom border-gray-800 pb-30 mb-30 wow animate__animated animate__fadeIn'>
                          ...
                          <div className='card-info'>
                            <Link href='/single-sidebar'>
                              <h3 className='mb-20 color-white'>How Young Indian Digital Artists See A New Future In NFTs</h3>
                            </Link>
                            <p className='color-gray-500'>
                              Gosh jaguar ostrich quail one excited dear hello and bound and the and bland moral misheard roadrunner flapped
                              lynx far that and jeepers giggled far and far
                        ...
                        <div className='card-list-posts card-list-posts-small border-bottom border-gray-800 pb-30 mb-30 wow animate__animated animate__fadeIn'>
                          ...
                          <div className='card-info'>
                            <Link href='/single-sidebar'>
                              <h3 className='mb-20 color-white'>NFT: The new brush stroke in the Indian art world</h3>
                            </Link>
                            <p className='color-gray-500'>
                              Gosh jaguar ostrich quail one excited dear hello and bound and the and bland moral misheard roadrunner flapped
                              lynx far that and jeepers giggled far and far
