                    ...
                    <div className='row mt-50 align-items-end'>
                      ...
                      <div className='col-lg-3 col-md-4'>
                        <div className='box-share border-gray-800'>
                          ...
                          <Link
                            className='icon-media icon-fb'
                            href='#'
                          />
                          <Link
                            className='icon-media icon-tw'
                            href='#'
                          />
                          <Link
                      ...
                      <div className='col-lg-8'>
                        <div className='content-detail border-gray-800'>
                          <p className='text-xl color-gray-500'>
                            The fancy moon going in little artist painting. Thirty days of lavender in the dreamy light inside. Other
                            perfect oh plants, for and again. I’ve honey feeling. Caring dreamland projects noteworthy than minimal, their
                          ...
                          <p className='text-lg color-gray-500 mb-50'>
                            Tortor placerat bibendum consequat sapien, facilisi facilisi pellentesque morbi. Id conse ctetur ut vitae a
                            massa a. Lacus ut bibendum sollicitudin fusce sociis mi. Dictum volutpat praesent ornare accumsan elit
                            venenatis. Congue sodales nunc quis ultricies odio porta. Egestas mauris placerat leo phasellu s ut sit.
                          </p>
                          <h3 className='color-white mb-30'>Use your headings</h3>
                          <p className='text-lg color-gray-500'>
                            Thirty there &amp; time wear across days, make inside on these you. Can young a really, roses blog small of song
                            their dreamy life pretty? Because really duo living to noteworthy bloom bell. Transform clean daydreaming cute
                            twenty process rooms cool. White white dreamy dramatically place everything although. Place out apartment
                            afternoon whimsical kinder, little romantic joy we flowers handmade. Thirty she a studio of she whimsical
                            projects, afternoon effect going an floated maybe.
                          </p>
                          <div className='bg-gray-850 box-quote'>
                            <h3 className='color-gray-500'>
                              Blandit consequat feugiat sed dapibus lorem diam nibh venenatis sodales pulvinar augue adipiscing turpis nulla
                              sit tincidunt non lacus sit amet et white dreamy dramatically place.
                            </h3>
                          ...
                          <div className='row'>
                            <div className='col-lg-8 mb-30'>
                              <p className='text-lg color-gray-500 mb-40'>
                                Thirty there &amp; time wear across days, make inside on these you. Can young a really, roses blog small of
                                song their dreamy life pretty? Because really duo living to noteworthy bloom bell. Transform clean
                                daydreaming cute twenty process rooms cool. White white dreamy dramatically place everything although.
                              </p>
                              <p className='text-lg color-gray-500'>
                                White white dreamy dramatically place everything although. Place out apartment afternoon whimsical kinder,
                                little romantic joy we flowers handmade. Thirty she a studio of she whimsical projects, afternoon effect
                          ...
                          <p className='text-lg color-gray-500'>
                            Tortor placerat bibendum consequat sapien, facilisi facilisi pellentesque morbi. Id consectetur ut vitae a massa
                            a. Lacus ut bibendum sollicitudin fusce sociis mi. Dictum volutpat praesent ornare accumsan elit venenatis.
                            Congue sodales nunc quis ultricies odio porta. Egestas mauris placerat leo phasellus ut sit.
                          </p>
                          <div className='row mt-50'>
                              ...
                              <div className='list-posts'>
                                <div className='item-post wow animate__animated animate__fadeIn'>
                                  ...
                                  <div className='info-post border-gray-800'>
                                    <Link href='/single-sidebar'>
                                      <h6 className='color-white'>Creating is a privilege but it’s also a gift</h6>
                                    </Link>
                                ...
                                <div className='item-post wow animate__animated animate__fadeIn'>
                                  ...
                                  <div className='info-post border-gray-800'>
                                    <Link href='/single-sidebar'>
                                      <h6 className='color-white'>Being unique is better than being perfect</h6>
                                    </Link>
                                    <span className='color-gray-700'>15 mins read</span>
                                    <ul className='d-inline-block'>
                                      <li className='color-gray-700'>15 April 2023</li>
                                ...
                                <div className='item-post wow animate__animated animate__fadeIn'>
                                  ...
                                  <div className='info-post border-gray-800'>
                                    <Link href='/single-sidebar'>
                                      <h6 className='color-white'>Every day, in every city and town across the country</h6>
                                    </Link>
                                    <span className='color-gray-700'>15 mins read</span>
                                    <ul className='d-inline-block'>
                                      <li className='color-gray-700'>15 April 2023</li>
                                ...
                                <div className='item-post wow animate__animated animate__fadeIn'>
                                  ...
                                  <div className='info-post border-gray-800'>
                                    <Link href='/single-sidebar'>
                                      <h6 className='color-white'>Your voice, your mind, your story, your vision</h6>
                                    </Link>
                                    <span className='color-gray-700'>15 mins read</span>
                                    <ul className='d-inline-block'>
                                      <li className='color-gray-700'>15 April 2023</li>
                              ...
                              <div className='list-comments'>
                                <div className='item-comment border-gray-800 wow animate__animated animate__fadeIn'>
                                  ...
                                  <div className='box-author-small'>
                                    ...
                                    />
                                    <div className='author-info'>
                                      <span className='d-block color-gray-700 text-sm'>Jane Cooper</span>
                                      <span className='color-gray-700 text-xs'>15 April 2023</span>
                                    </div>
                                  </div>
                                </div>
                                <div className='item-comment border-gray-800 wow animate__animated animate__fadeIn'>
                                  ...
                                  <div className='box-author-small'>
                                    ...
                                    />
                                    <div className='author-info'>
                                      <span className='d-block color-gray-700 text-sm'>Katen Doe</span>
                                      <span className='color-gray-700 text-xs'>15 April 2023</span>
                                    </div>
                                  </div>
                                </div>
                                <div className='item-comment border-gray-800 wow animate__animated animate__fadeIn'>
                                  ...
                                  <div className='box-author-small'>
                                    ...
                                    />
                                    <div className='author-info'>
                                      <span className='d-block color-gray-700 text-sm'>Barbara Cartland</span>
                                      <span className='color-gray-700 text-xs'>15 April 2023</span>
                                    </div>
                                  </div>
                                </div>
