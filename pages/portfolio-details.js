                    ...
                    <div className='swiper-wrapper wow animate__animated animate__fadeIn'>
                      ...
                      <div className='swiper-slide'>
                        <div className='image-detail mb-30'>
                          <img
                            className='bdrd16'
                            src='assets/imgs/page/portfolio/portfolio-1-2.png'
                            alt='Genz'
                          />
                        </div>
                      </div>
                      <div className='swiper-slide'>
                        <div className='image-detail mb-30'>
                          <img
                            className='bdrd16'
                            src='assets/imgs/page/portfolio/portfolio-1-3.png'
                            alt='Genz'
                          />
                        </div>
                      </div>
                      <div className='swiper-slide'>
                        <div className='image-detail mb-30'>
                          <img
                            className='bdrd16'
                            src='assets/imgs/page/portfolio/portfolio-1-1.png'
                            alt='Genz'
                          />
                        </div>
                      </div>
                  ...
                  <div className='col-lg-8'>
                    <div className='content-detail border-gray-800'>
                      ...
                      <p className='text-lg color-gray-500 wow animate__animated animate__fadeIn'>
                        ...
                        twenty process rooms cool. White white dreamy dramatically place everything although. Place out apartment afternoon
                        whimsical kinder, little romantic joy we flowers handmade. Thirty she a studio of she whimsical projects, afternoon
                        effect going an floated maybe.
                      </p>
                      <p className='text-lg color-gray-500 wow animate__animated animate__fadeIn'>
                        Tortor placerat bibendum consequat sapien, facilisi facilisi pellentesque morbi. Id consectetur ut vitae a massa a.
                        Lacus ut bibendum sollicitudin fusce sociis mi. Dictum volutpat praesent ornare accumsan elit venenatis. Congue
                        sodales nunc quis ultricies odio porta. Egestas mauris placerat leo phasellus ut sit.
                      </p>
                      <div className='row mt-50 wow animate__animated animate__fadeIn'>
                        <div className='col-lg-6 gallery-left'>
                          <img
                            ...
                            src='assets/imgs/page/portfolio/portfolio-2.png'
                            alt='Genz'
                          />
                        </div>
                        <div className='col-lg-6 gallery-right'>
                          <img
                            ...
                            src='assets/imgs/page/portfolio/portfolio-3.png'
                            alt='Genz'
                          />
                          <img
                            className='img-bdrd-16'
                            src='assets/imgs/page/portfolio/portfolio-4.png'
                            alt='Genz'
                          />
                        </div>
                      </div>
