$.fn.progressScroll = function (e) {
  ...
  this.updateProgress = function (e) {
    ...
    if (r <= 180) {
      $('.' + s, a).css(
        'background-image',
        'linear-gradient(' + (90 + r) + 'deg, transparent 50%, #0F172A 50%),linear-gradient(90deg, #0F172A 50%, transparent 50%)'
      )
    } else {
      $('.' + s, a).css(
        'background-image',
        'linear-gradient(' + (r - 90) + 'deg, transparent 50%, #0EA5EA 50%),linear-gradient(90deg, #0F172A 50%, transparent 50%)'
      )
    }
    $('.' + l, a).text()
  }
