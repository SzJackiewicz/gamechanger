...
!(function (e, t, n) {
      ...
      if (b.hasOwnProperty(l)) {
        ...
        for (o = r(t.fn, 'function') ? t.fn() : t.fn, i = 0; i < e.length; i++)
          (a = e[i]),
            ...
            1 === s.length
              ? (Modernizr[s[0]] = o)
              : (!Modernizr[s[0]] || Modernizr[s[0]] instanceof Boolean || (Modernizr[s[0]] = new Boolean(Modernizr[s[0]])),
                (Modernizr[s[0]][s[1]] = o)),
            C.push((o ? '' : 'no-') + s.join('-'))
      }
  }
  ...
  function d(e, n, r, o) {
    var i,
      ...
      d = l('div'),
      p = f()
    if (parseInt(r, 10)) for (; r--; ) (s = l('div')), (s.id = o ? o[r] : c + (r + 1)), d.appendChild(s)
    return (
      (i = l('style')),
      (i.type = 'text/css'),
      (i.id = 's' + c),
      ...
      (d.id = c),
      p.fake &&
        ((p.style.background = ''), (p.style.overflow = 'hidden'), (u = _.style.overflow), (_.style.overflow = 'hidden'), _.appendChild(p)),
      (a = n(d, e)),
  ...
  T ||
    !(function (e, t) {
      ...
      function a(e, n, r) {
        ...
        var o
        return (
          (o = r.cache[e] ? r.cache[e].cloneNode() : h.test(e) ? (r.cache[e] = r.createElem(e)).cloneNode() : r.createElem(e)),
  ...
  ;(S.testAllProps = A),
    ...
    (function () {
      ...
      for (
        ...
        (e = n[r].toLowerCase()),
          (t = A('column' + n[r])),
          ('breakbefore' === e || 'breakafter' === e || 'breakinside' == e) && (t = t || A(n[r])),
