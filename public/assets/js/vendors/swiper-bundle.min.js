...
!(function (e, t) {
  ...
  function C() {
    for (
      var e = Object(arguments.length <= 0 ? void 0 : arguments[0]), t = ['__proto__', 'constructor', 'prototype'], a = 1;
      a < arguments.length;
      a += 1
    ) {
    ...
    V = {
      ...
      loop: {
        ...
        loopFix: function () {
          ...
          if (a < s)
            (t = i.length - 3 * s + a), (t += s), e.slideTo(t, 0, !1, !0) && 0 !== d && e.setTranslate((l ? -e.translate : e.translate) - d)
        ...
        attachEvents: function () {
          ...
          ;(a.preventClicks || a.preventClicksPropagation) && s.addEventListener('click', e.onClick, !0),
            ...
            a.updateOnWindowResize
              ? e.on(o.ios || o.android ? 'resize orientationchange observerUpdate' : 'resize observerUpdate', G, !0)
      ...
      handle: function (e) {
        ...
        if (
          ...
          if (
            (T.push(y),
            S
              ? (y.direction !== S.direction || y.delta > S.delta || y.time > S.time + 150) && a.mousewheel.animateSlider(y)
    ...
    Z = {
      ...
      update: function () {
        ...
        if (!e.params.loop) {
          ...
          r &&
            r.length > 0 &&
            (e.isBeginning ? a(r, !0) : a(r, !1), r[e.params.watchOverflow && e.isLocked ? 'addClass' : 'removeClass'](t.lockClass)),
            s &&
              s.length > 0 &&
              (e.isEnd ? a(s, !0) : a(s, !1), s[e.params.watchOverflow && e.isLocked ? 'addClass' : 'removeClass'](t.lockClass))
        }
      },
          ...
          if (t.realIndex !== a.realIndex || r) {
            ...
            r && (n += 'next' === o ? s : -1 * s),
              a.visibleSlidesIndexes &&
                ...
                (a.params.centeredSlides ? (n = n > l ? n - Math.floor(i / 2) + 1 : n + Math.floor(i / 2) - 1) : n > l && (n = n - i + 1),
