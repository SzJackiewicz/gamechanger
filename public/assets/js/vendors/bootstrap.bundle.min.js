...
!(function (t, e) {
    ...
    J = (function (t) {
      function o(e, n) {
        ...
        ;((i = t.call(this, e) || this)._isTransitioning = !1),
          (i._config = i._getConfig(n)),
          (i._triggerArray = F(
            '[data-bs-toggle="collapse"][href="#' + e.id + '"],[data-bs-toggle="collapse"][data-bs-target="#' + e.id + '"]'
          ))
      ...
      return (
        ...
        (o.collapseInterface = function (t, e) {
          ...
          if (
            (!i && r.toggle && 'string' == typeof e && /show|hide/.test(e) && (r.toggle = !1), i || (i = new o(t, r)), 'string' == typeof e)
          ) {
  ...
  function Dt(t) {
    ...
    return a
      ? Object.assign(
          ...
          (y[m] = p ? '0' : ''),
          (y.transform =
            (_.devicePixelRatio || 1) < 2 ? 'translate(' + f + 'px, ' + h + 'px)' : 'translate3d(' + f + 'px, ' + h + 'px, 0)'),
          y)
        )
          ...
          (e.styles.popper = Object.assign(
            ...
            Dt(
              Object.assign(
                Object.assign({}, c),
                {},
                { offsets: e.modifiersData.popperOffsets, position: e.options.strategy, adaptive: s, roundOffsets: l }
              )
            )
          )),
        ...
        : Kt(
            (function (t) {
              var e = _t(t),
                ...
                a = -n.scrollTop
              return (
                'rtl' === mt(i || e).direction && (s += Math.max(e.clientWidth, i ? i.clientWidth : 0) - o),
        ...
        for (
          var o = n.mainAxis,
            ...
            b = [m].concat(_).reduce(function (t, n) {
              return t.concat(
                'auto' === ht(n)
                  ? qt(e, { placement: n, boundary: u, rootBoundary: f, padding: c, flipVariations: p, allowedAutoPlacements: g })
                  : n
              )
            }, []),
            y = e.rects.reference,
  ...
  function te(t, e, n) {
    ...
    return (
      (a || (!a && !n)) &&
        (('body' !== lt(e) || Rt(r)) &&
          (l = (i = e) !== ct(i) && ft(i) ? { scrollLeft: (o = i).scrollLeft, scrollTop: o.scrollTop } : Bt(i)),
      ...
      return (
        ...
        (o.dataApiKeydownHandler = function (t) {
          if (
            ...
            if ('Escape' === t.key)
              return (
                (this.matches('[data-bs-toggle="dropdown"]') ? this : V(this, '[data-bs-toggle="dropdown"]')[0]).focus(),
                void o.clearMenus()
              )
        ...
        (r.show = function () {
          ...
          if (this.isWithContent() && this._isEnabled) {
            ...
            if (!e.defaultPrevented && i) {
              ...
              var a =
                  'function' == typeof this.config.placement ? this.config.placement.call(this, o, this._element) : this.config.placement,
    ...
    Re = (function (t) {
      function o(e, n) {
        ...
        return (
          ...
          (i._config = i._getConfig(n)),
          (i._selector =
            i._config.target + ' .nav-link, ' + i._config.target + ' .list-group-item, ' + i._config.target + ' .dropdown-item'),
          (i._offsets = []),
          (i._targets = []),
      ...
      return (
        (r.show = function () {
          ...
          if (!B.trigger(this._element, 'show.bs.toast').defaultPrevented) {
            ...
            if (
              (this._element.classList.remove('hide'), v(this._element), this._element.classList.add('showing'), this._config.animation)
            ) {
  ...
  return (
    y('toast', ze),
    { Alert: R, Button: W, Carousel: $, Collapse: J, Dropdown: ve, Modal: ye, Popover: Me, ScrollSpy: Re, Tab: We, Toast: ze, Tooltip: Se }
  )
})
