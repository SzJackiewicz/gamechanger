                    ...
                    >
                      ...
                      >
                        ...
                        <div className='card-info'>
                          ...
                          <Link href={`/blog/${item.id}`}>
                            <h5 className='mb-10 color-white'>{item.title}</h5>
                          </Link>
                          <div className='row mt-10'>
                            <div className='col-12'>
                              <span className='calendar-icon color-gray-700 text-sm mr-20'>{item.date}</span>
                              <span className='color-gray-700 text-sm timeread'>{item.date}</span>
                            </div>
                          </div>
                        </div>
                      </div>
