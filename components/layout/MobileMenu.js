                  ...
                  <ul className='mobile-menu font-heading'>
                    ...
                    >
                      ...
                      <ul className={isActive.key == 2 ? 'sub-menu d-block' : 'sub-menu d-none'}>
                        <li>
                          <Link href='/blog-archive'>Blog Category 1</Link>
                        </li>
                        <li>
                          <Link href='/blog-archive-2'>Blog Category 2</Link>
                        </li>
                        <li>
                          <Link href='/blog-archive-3'>Blog Category 3</Link>
                        </li>
                        <li>
                          <Link href='/blog-archive-4'>Blog Category 4</Link>
                        </li>
                        <li>
                          <Link href='/blog-archive-5'>Blog Category 5</Link>
                        </li>
                      </ul>
                    </li>
                    <li
                    ...
                    >
                      ...
                      <ul className={isActive.key == 3 ? 'sub-menu d-block' : 'sub-menu d-none'}>
                        <li>
                          <Link href='/single-sidebar'>Blog Single 1</Link>
                        </li>
                        <li>
                          <Link href='/single-no-sidebar'>Blog Single 2</Link>
                        </li>
                        <li>
                          <Link href='/single-center'>Blog Single 3</Link>
                        </li>
                      </ul>
                    </li>
                    <li
                    ...
                    >
                      ...
                      <ul className={isActive.key == 4 ? 'sub-menu d-block' : 'sub-menu d-none'}>
                        ...
                        <li>
                          <Link href='/page-author'>Author posts</Link>
                        </li>
                        <li>
                          <Link href='/page-contact'>Contact</Link>
                        </li>
                        <li>
                          <Link href='/page-search'>Search results</Link>
                        </li>
                        <li>
                          <Link href='/page-login'>Login</Link>
                        </li>
                        <li>
                          <Link href='/page-signup'>Signup</Link>
                        </li>
                        <li>
